...
import DocumentPage from './src/pages/DocumentsPage';
import DocumentEditPage from './src/pages/DocumentEditPage';

import { initRouter, push, replace, replaceBack } from './src/utils/router';
